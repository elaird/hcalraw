...
def oparser(arg=""):
    ...
    dump = ["dump level (default is -1)",
            ...
            "5: data (fib=all   fibCh=1   ErrF == 0)",
            "6: data (fib=all   fibCh=1   ErrF == 0); TPs (> 0)",
            "7: data (fib=all   fibCh=1            ); TPs (> 0)",
            "8: data (                    ErrF == 0); TPs (> 0)",
            "9: data (all)                          ; TPs (all)",
            "10: data(                    ErrF != 0); TPs (!OK)",
            "11: data(                    ErrF == 0); TPs (all)",
            "12: 64bit words; all data and TPs",
            "13: 64(+16)bit words; all data and TPs",
            ]
