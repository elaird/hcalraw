...
if utca:
    process.source = cms.Source("HcalTBSource",
                                ...
                                #'file:/afs/cern.ch/user/e/elaird/USC_209311.root')
                                )
    ...
    process.source = cms.Source("PoolSource",
                                fileNames=cms.untracked.vstring("file:/afs/cern.ch/user/e/elaird/12_utca/209151.7AB1CF02-D647-E211-B6E0-003048D3751E.root"),
                                )
    ...
    process.hlt = cms.EDFilter("HLTHighLevel",
                               TriggerResultsTag=cms.InputTag("TriggerResults",
                                                              "",
                                                              "HLT"),
                               #list of HLT paths (or patterns)
                               HLTPaths=cms.vstring("HLT_HcalUTCA_v1"),
                               eventSetupPathsKey=cms.string(''),
                               #for multiple triggers,
                               #True does OR; False does AND
                               andOr=cms.bool(True),
    ...
    if produceDigis:
        process.p = cms.Path(process.hlt * process.hcalDigis)
    else:
